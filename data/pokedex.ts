export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	snake: {
		...
		types: ["Fighting", "Dark"],
		gender: "M",
		baseStats: { hp: 80, atk: 120, def: 117, spa: 55, spd: 85, spe: 75 },
	...
	berdly: {
		...
		name: "Berdly",
		types: ["Flying"],
		baseStats: { hp: 65, atk: 105, def: 70, spa: 105, spd: 80, spe: 95 },
		abilities: { 0: "Analytic" },
		heightm: 1.4,
		weightkg: 50,
		color: "Blue",
	...
	hathy: {
		...
		name: "Hathy",
		types: ["Fairy"],
		baseStats: { hp: 120, atk: 40, def: 50, spa: 65, spd: 70, spe: 35 },
	...
	headhathy: {
		...
		name: "Head Hathy",
		types: ["Fairy", "Ice"],
		baseStats: { hp: 130, atk: 60, def: 70, spa: 95, spd: 95, spe: 55 },
		abilities: { 0: "Regenerator" },
		heightm: 1.3,
		weightkg: 35,
		color: "Blue",
