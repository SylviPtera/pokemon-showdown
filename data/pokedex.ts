export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	joker: {
		...
		abilities: { 0: "Pickpocket", 1: "Infiltrator", H: "Skill Link" },
		heightm: 1.4,
		weightkg: 50,
		color: "Black",
		eggGroups: ["Human-Like"],
	...
	napstablook: {
		...
		abilities: { 0: "Clear Body", H: "Rhythmic Beat" },
		heightm: 1.4,
		weightkg: 0.1,
		color: "White",
		eggGroups: ["Amorphous"],
	...
	torrt: {
		...
		name: "Torrt",
		types: ["Ground", "Rock"],
		baseStats: { hp: 125, atk: 110, def: 160, spa: 85, spd: 85, spe: 30 },
	...
	plixie: {
		...
		name: "Plixie",
		types: ["Fairy", "Psychic"],
		baseStats: { hp: 80, atk: 80, def: 70, spa: 135, spd: 125, spe: 115 },
	...
	vhamp: {
		...
		name: "Vhamp",
		types: ["Steel"],
		baseStats: { hp: 95, atk: 80, def: 135, spa: 115, spd: 115, spe: 70 },
	...
	syncopite: {
		...
		name: "Syncopite",
		types: ["Rock", "Psychic"],
		baseStats: { hp: 90, atk: 90, def: 135, spa: 110, spd: 125, spe: 45 },
	...
	iggy: {
		...
		name: "Iggy",
		types: ["Rock"],
		baseStats: { hp: 65, atk: 95, def: 125, spa: 65, spd: 70, spe: 105 },
