export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	undyne: {
		...
		abilities: { 0: "Justified", 1: "Dry Skin", H: "True Hero" },
		heightm: 1.9,
		weightkg: 180,
		color: "Blue",
		eggGroups: ["Water 1"],
	...
	spamton: {
		...
		baseForme: "Spamton",
		types: ["Dark"],
		baseStats: { hp: 65, atk: 90, def: 70, spa: 125, spd: 55, spe: 75 },
		abilities: { 0: "Berserk" },
		heightm: 0.6,
		weightkg: 50,
		color: "White",
		eggGroups: ["Human-Like"],
		otherFormes: ["Spamton-NEO"],
	...
	spamtonneo: {
		...
		forme: "NEO",
		types: ["Dark"],
		baseStats: { hp: 80, atk: 97, def: 97, spa: 145, spd: 76, spe: 105 },
