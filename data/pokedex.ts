export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	luigi: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: { hp: 85, atk: 95, def: 60, spa: 105, spd: 90, spe: 110 },
	...
	sheik: {
		...
		gender: "F",
		baseStats: { hp: 75, atk: 97, def: 55, spa: 90, spd: 55, spe: 151 },
	...
	zelda: {
		...
		types: ["Fairy", "Psychic"],
		gender: "F",
		baseStats: { hp: 75, atk: 63, def: 80, spa: 115, spd: 120, spe: 65 },
	...
	drmario: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: { hp: 85, atk: 85, def: 115, spa: 70, spd: 115, spe: 75 },
		abilities: { 0: "Healer" },
		heightm: 1.3,
		weightkg: 75,
		color: "White",
	...
	ganondorf: {
		...
		types: ["Dark"],
		gender: "M",
		baseStats: { hp: 107, atk: 163, def: 82, spa: 133, spd: 120, spe: 70 },
