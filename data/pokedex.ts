export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	queen: {
		...
		name: "Queen",
		types: ["Electric", "Steel"],
		baseStats: { hp: 85, atk: 90, def: 105, spa: 125, spd: 90, spe: 105 },
		abilities: { 0: "Queenly Majesty" },
		heightm: 2,
		weightkg: 75,
		color: "Blue",
	...
	spamtonmega: {
		...
		forme: "Mega",
		types: ["Dark"],
		baseStats: { hp: 67, atk: 97, def: 108, spa: 145, spd: 75, spe: 105 },
	...
	roaringknight: {
		...
		name: "Roaring Knight",
		types: ["Dark"],
		baseStats: { hp: 85, atk: 150, def: 110, spa: 120, spd: 100, spe: 115 },
