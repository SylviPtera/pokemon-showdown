export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	peach: {
		...
		types: ["Fairy"],
		gender: "F",
		baseStats: { hp: 90, atk: 60, def: 85, spa: 90, spd: 115, spe: 60 },
	...
	daisy: {
		...
		gender: "F",
		baseStats: { hp: 70, atk: 110, def: 65, spa: 72, spd: 60, spe: 123 },
	...
	kingdedede: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: { hp: 150, atk: 131, def: 85, spa: 70, spd: 110, spe: 54 },
